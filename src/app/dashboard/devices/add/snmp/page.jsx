        ...
        <>
            <div className="bg-white min-h-screen">
                ...
                <div className="p-4 flex items-center justify-between">
                    <h1 className="text-xl font-semibold">New Device - SNMP</h1>
                ...
                <div className="w-94 p-4">
                    ...
                    <p className='mb-4 text-nowrap'>Monitor SNMP devices with your installed Windows agents. Once added, you can view connectivity status and manage OIDs, alert thresholds and more.<Link href='#' className='text-blue-500'> Learn more</Link></p>
